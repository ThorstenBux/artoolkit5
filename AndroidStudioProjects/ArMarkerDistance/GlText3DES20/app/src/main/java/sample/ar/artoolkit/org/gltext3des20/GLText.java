...
package sample.ar.artoolkit.org.gltext3des20;
...
import sample.ar.artoolkit.org.gltext3des20.programs.BatchTextProgram;
import sample.ar.artoolkit.org.gltext3des20.programs.Program;
...
public class GLText {
	...
	public GLText(Program
						  program, AssetManager assets) {
		if (program == null) {
